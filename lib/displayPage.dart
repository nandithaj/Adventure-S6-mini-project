...
class _DisplayAdImageState extends State<DisplayAdImage> {
  ...
  Future<void> _fetchAd() async {
    ...
    final Uri url = Uri.parse('http://192.168.13.123:5000/get-ad/$screenId'); // Replace with your backend URL
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        if (newVideoUrl != null && newVideoUrl != _videoUrl) {
          ...
          _controller = VideoPlayerController.network('http://192.168.13.123:8080/$_videoUrl');
